...
const (
	...
	cstxConsumerProcessDelay = 3 * time.Second
...
func TestIntegration_CSTX_OneConsumerTimeoutError(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
...
func TestIntegration_CSTX_TwoConsumersTimeoutWhenFirstDelayedError(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
...
func TestIntegration_CSTX_TwoConsumersTimeoutWhenSecondDelayedError(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
